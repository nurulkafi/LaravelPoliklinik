        ...
        <div class="card-header">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h5>Data Media Pembayaran</h5>
                    </div>
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <a class="btn btn-primary float-start float-lg-end" href="{{ url('admin/media_pembayaran/create') }}">
                            Tambah data
                        </a>
                    </div>
                </div>
                ...
                <table id="table1" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-info" href="{{ url('admin/media_pembayaran/'.$item->id.'/edit') }}" >
                                    Edit
                                </a>
...
<script>
    ...
    $(document).ready(function() {
        $('.hapusData').on('click',function () {
            ...
            $('#form').attr('action','media_pembayaran/'+id);
        });
    });
</script>
@endpush
