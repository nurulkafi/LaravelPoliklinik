        ...
        <div class="card-header">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h5>Data Jenis Biaya</h5>
                    </div>
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <a class="btn btn-primary float-start float-lg-end" href="{{ url('admin/jenis_biaya/create') }}">
                            Tambah data
                        </a>
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        $('.hapusData').on('click',function () {
            ...
            $('#form').attr('action','jenis_biaya/'+id);
        });
    });
</script>
@endpush
